...
export default function venues() {
  ...
  const venueColumns: Column<VenueType>[] = [
    ...
    { key: "venueID", label: "Oturma Planı", columnType: "action", filterType: "none", render:  (row) => (
                      <button
                        onClick={() =>
                          router.push(
    ...
    { key: "venueID", label: "Düzenle", columnType: "action", filterType: "none", render:  (row) => (
                            <button
                        onClick={() => {
                          handleOpenEdit(row);
                        }}
      ...
      <div>
        <div className="my-10 flex justify-center overflow-x-auto">
          <table className="table sm:table-auto sm:w-6/12  table-zebra border-2 border-black dark:border-white">
            ...
            <tbody>
              {venues.map((venue) => (
                <tr className="font-bold" key={venue.venueID}>
                  <td>{venue.city}</td>
