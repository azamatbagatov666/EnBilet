  ...
  return (
    <>
      <div className="h-[90vh] flex items-center justify-center flex-wrap">
        <div className="p-8 border-2 border-black rounded-3xl bg-white transition-colors duration-300">
          <div className="text-black text-3xl flex font-bold justify-center mb-8">
            ÜYE GİRİŞİ
          </div>
