...
export default function Row({
  ...
  return (
    <div className="flex items-center gap-2 mb-2 select-none">
      ...
      <div className="bg-white duration-200 cursor-move font-bold w-7 h-10 grid rounded-lg">
        <button
          onClick={() => moveRowUp(row.id)}
            className={`
    flex justify-center rounded-t-lg outline-none
    ${index==0 ? "opacity-30 cursor-not-allowed" : "hover:bg-red-500"}
  `}
        >
        ...
        <button
          onClick={() => moveRowDown(row.id)}
            className={`
    flex justify-center rounded-b-lg outline-none
    ${index === totalRows - 1 ? "opacity-30 cursor-not-allowed" : "hover:bg-red-500"}
  `}
        >
          <svg
            width="20px"
