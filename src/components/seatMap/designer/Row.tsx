  ...
  return (
    <div className="flex items-center gap-2 mb-2 select-none">
      ...
      <div className="tooltip inline-flex" data-tip="Sırayı Taşı">
        <div
          {...dragHandleProps}
          className="hover:bg-red-500 dark:bg-zinc-700 text-black dark:text-white bg-white duration-200 cursor-move font-bold w-20 h-10 flex justify-center items-center border-2 border-gray-500 rounded-md px-4!"
        >
